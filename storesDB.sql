...
(5, 'Neighbours Market', '278 King St', 'Convenience', 'images/neighbours.png', 4.5, '7:00 AM - 11:00 PM', NOW() - INTERVAL 1 WEEK),
(6, 'Nofrills', '24 Forwell Creek Rd', 'Grocery', 'images/nofrills.jpg', 4.6, '9:00 AM - 9:00 PM', NOW());

INSERT INTO MenuItems (MenuItemID, StoreID, MenuName, Description, OriginalPrice, DiscountedPrice, MenuImageURL, Stock) VALUES 
(100, 1, 'Kamjatang', 'Pork bone soup', 17.99, 8.99, 'images/kamjatang.png', 3),
...
(600, 6, 'Fresh Tomatoes', 'Locally sourced tomatoes', 4.99, 2.99, 'images/tomatoes.png', 10);